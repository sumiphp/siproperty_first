...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 29, 2024 at 02:02 PM
...
(2, 'fb112', 'twit11', 'you tube1', 'linked11', '1723800307settings.png', '1724156018settings.png', 'SI property has completed over 50 top-of-line projects making them one of the most trusted builders in Trivandrum, with a significant presence in both the residential and commercial sectors.n fb', 'insta11', 'Pangode1', 'Trivandrum1', '944716 9988');
...
--
ALTER TABLE `newslettersubscribe`
  MODIFY `newsletterid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
